...
#[CoversMethod(TrueTypeFont::class, 'getFontName')]
final class GetFontNameTest extends TestCase
{
    #[Test]
    public function getFontNameReturnsStoredValue(): void
    {
        // Arrange
        $rc = new ReflectionClass(TrueTypeFont::class);
        $font = $rc->newInstanceWithoutConstructor();
        $prop = $rc->getProperty('fontName');
        $prop->setValue($font, 'NotoSans-Regular');

        // Act / Assert
        self::assertSame('NotoSans-Regular', $font->getFontName());
    }
}
