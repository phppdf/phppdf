...
#[CoversMethod(Type1FontMetrics::class, 'courierOblique')]
final class CourierObliqueTest extends TestCase
{
    #[Test]
    public function courierObliqueReturnsInstance(): void
    {
        $metrics = Type1FontMetrics::courierOblique();
