...
#[CoversMethod(PdfContentStreamBuilder::class, 'drawSvg')]
...
final class DrawSvgTest extends TestCase
{
    #[Test]
    public function drawSvgReturnsSelf(): void
    {
        $builder = new PdfContentStreamBuilder();
        self::assertSame($builder, $builder->drawSvg('Svg1', 0.0, 0.0, 100.0, 100.0));
    }

    #[Test]
    public function drawSvgDelegatesToDrawImage(): void
    {
        $builder = new PdfContentStreamBuilder();
        $builder->drawSvg('Svg1', 10.0, 20.0, 200.0, 150.0);
