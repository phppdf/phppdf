...
namespace PhpPdf\Content\Operation\SetNonStrokingGray;
...
#[CoversClass(SetNonStrokingGray::class)]
#[CoversMethod(SetNonStrokingGray::class, 'minimumVersion')]
final class MinimumVersionTest extends TestCase
{
    ...
    {
        // Arrange / Act
        $version = (new SetNonStrokingGray(0.5))->minimumVersion();
