...
#[CoversMethod(ComputedStyle::class, 'setFontSize')]
final class SetFontSizeTest extends TestCase
{
    #[Test]
    public function storesFontSize(): void
    {
        // Arrange
        ...
        // Assert
        self::assertSame(16.0, $style->getFontSize());
    }
}
