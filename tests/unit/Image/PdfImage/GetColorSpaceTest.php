...
#[CoversMethod(PdfImage::class, 'getColorSpace')]
final class GetColorSpaceTest extends TestCase
{
    #[Test]
    public function getColorSpaceReturnsStoredColorSpace(): void
    {
        // Arrange — 3-component JPEG → DeviceRGB
