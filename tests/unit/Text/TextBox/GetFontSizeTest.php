...
#[CoversMethod(TextBox::class, 'getFontSize')]
final class GetFontSizeTest extends TestCase
{
    #[Test]
    public function getFontSizeReturnsConfiguredFontSize(): void
    {
        ...
        $box = TextBox::create('Hello', $metrics, fontSize: 12, maxWidth: 200);

        self::assertEqualsWithDelta(12.0, $box->getFontSize(), 0.001);
    }
}
