...
#[CoversMethod(TextBox::class, 'getLineHeight')]
final class GetLineHeightTest extends TestCase
{
    #[Test]
    public function getLineHeightReturnsConfiguredValue(): void
    {
        ...
        $box = TextBox::create('Hello', $metrics, fontSize: 10, maxWidth: 200, lineHeight: 16);
