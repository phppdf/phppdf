...
#[CoversMethod(PdfDocument::class, 'getObjects')]
#[UsesClass(PdfDictionary::class)]
#[UsesClass(PdfIndirectObject::class)]
#[UsesClass(PdfIndirectReference::class)]
#[UsesClass(PdfObjectRegistry::class)]
final class GetObjectsTest extends TestCase
{
    #[Test]
    public function getObjectsReturnsTheRegistry(): void
    {
        // Arrange
