...
#[CoversMethod(PdfDocument::class, 'getVersion')]
...
{
    #[Test]
    public function getVersionReturnsStoredVersion(): void
    {
        // Arrange
        $registry = new PdfObjectRegistry();
        $catalogRef = $registry->register(new PdfDictionary([]));
        $document = new PdfDocument($registry, PdfVersion::PDF_2_0, $catalogRef, null);

        // Act
        $result = $document->getVersion();

        // Assert
        self::assertSame(PdfVersion::PDF_2_0, $result);
    }
}
