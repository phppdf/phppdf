...
namespace PhpPdf\Object\PdfOutlineItem;
...
#[CoversClass(PdfOutlineItem::class)]
#[CoversMethod(PdfOutlineItem::class, '__construct')]
...
final class ConstructorTest extends TestCase
{
    ...
    public function constructorCreatesInstance(): void
    {
        ...
        // Act
        $obj = new PdfOutlineItem('Chapter 1', $dest);
