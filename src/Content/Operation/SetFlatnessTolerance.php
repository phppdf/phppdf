...
final class SetFlatnessTolerance implements PdfContentOperation
{
    public function __construct(private float $flatness)
    {
    }
    ...
    {
        $serializer->writeLine(sprintf('%s i', $this->flatness));
    }
}
